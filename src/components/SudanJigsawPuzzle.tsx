...
const PUZZLE_IMAGES: PuzzleImage[] = [
  ...
  {
    id: 'meroe',
    title: 'أهرامات مروي والبجراوية التاريخية ⛰️',
    category: 'آثار وأمجاد كوش',
    src: '/sd/meroe.jpg',
    desc: 'أهرامات مروي الشامخة في ولاية نهر النيل؛ أعظم صروح ملوك وملكات مملكة كوش العظيمة.',
    color: 'from-amber-600 to-yellow-600'
  },
  {
    id: 'suakin',
    title: 'جزيرة سواكن التاريخية المرجانية 🏰',
    category: 'تراث ومعالم البحر الأحمر',
    src: '/sd/suakin.jpg',
    desc: 'مدينة القصور المرجانية البيضاء القديمة على ساحل البحر الأحمر وبوابة التجارة الإفريقية العريقة.',
    color: 'from-cyan-600 to-blue-700'
  },
  {
    id: 'sanganeb',
    title: 'فنار ومحمية سنقنيب المرجانية 🚢',
    category: 'عجائب الطبيعة البحرية',
    src: '/sd/sanganeb.jpg',
    desc: 'محمية سنقنيب البحرية ذات الفنار التاريخي الشاهق والشعاب المرجانية الساحرة في بورتسودان.',
    color: 'from-teal-600 to-emerald-700'
  },
  {
    id: 'mogran',
    title: 'مقرن النيلين الأزرق والأبيض 🌊',
    category: 'طبيعة وجمال الخرطوم',
    src: '/sd/mogran.jpg',
    desc: 'المشهد الساحر لملتقى النيل الأزرق الهادر مع النيل الأبيض الهادئ في قلب العاصمة الخرطوم.',
    color: 'from-blue-600 to-indigo-700'
  },
  {
    id: 'tebeldi',
    title: 'شجرة التبلدي الكردفانية العملاقة 🌳',
    category: 'بيئة وطبيعة كردفان',
    src: '/sd/tebeldi.jpg',
    desc: 'شجرة الباوباب المعمرة في بوادي كردفان؛ خزان الماء العذب الطبيعي وصيدلية ثمار القنقليز.',
